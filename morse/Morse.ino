...
void dot () {digitalWrite(led,HIGH); tone(buzz,800,300); delay (300); digitalWrite(led,LOW); delay (300); }//the dot this code make the led on for 300 than off for 300
void dash () {digitalWrite(led,HIGH); tone(buzz,800,900); delay (900); digitalWrite(led,LOW); delay (300);}//the dash this code make the led on for 900 than off for 300
